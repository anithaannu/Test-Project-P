pipeline {
	    ...
	    parameters {
	         string(name: 'tomcat_qa', defaultValue: '172.31.17.210', description: 'Staging Server')
	         string(name: 'tomcat_prod', defaultValue: '172.31.13.55', description: 'Production Server')
	    }
